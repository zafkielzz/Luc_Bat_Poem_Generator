...
| README công khai sau khi đóng dự án diễn giải kết quả final pilot thế nào? | Trang dự án nêu tách biệt free generation (base 31.8 vs adapter 35.3 overall, đều 0/12 strict-valid) và strict pipeline (cả hai 12/12, metric luật 100). Demo top-1 có từ vô nghĩa không được dùng làm bằng chứng chất lượng; final pilot chưa có human evaluation. | `README.md`; `experiments/tet4_v1/final_all117_clean_prompt_v1/`; `docs/HUMAN_EVAL.md`; `DEVLOG.md` Khoang 117 | Trình bày công khai trung thực; không tạo claim naturalness. |
